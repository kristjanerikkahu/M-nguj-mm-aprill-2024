...
var credits = [
	[
		"A game by Game Jam team Mangumoos"
	],[
		"Programming",
		...
		"",
		"Background music created with suno.ai",
		"Some sound effects created with jsfxr"
	],[
		"Special thanks",
		"UTJam team for the motivational pizzas and tutors!"
	]
]
